...
|            |            |                  |                   |
+------------+------------+------------------+-------------------+
| 2026-04-09 | 1.3.0      | John Keeney      | N Release         |
|            | Do Not Use |                  |                   |
|            |            |                  |                   |
+------------+------------+------------------+-------------------+
| 2026-04-09 | 1.3.1      | John Keeney      | N Release (fix)   |
|            |            |                  |                   |
+------------+------------+------------------+-------------------+
...
|                             |                                                                |
+-----------------------------+----------------------------------------------------------------+
| **Repo/commit-ID**          | nonrtric-controlpanel/fb9683fa6f729dc556e44beb803c7434f895b854 |
|                             |                                                                |
+-----------------------------+----------------------------------------------------------------+
...
|                             |                                                                |
+-----------------------------+----------------------------------------------------------------+
| **Purpose of the delivery** | nonrtric-gateway:1.3.0 - DO NOT USE                            |
|                             |    Minor improvements and stability updates                    |
|                             |    Upgrade baseline parents & base image                       |
|                             |    Contains a bug that prevent the container from starting     |
|                             |    Use v1.3.1 instead                                          |
+-----------------------------+----------------------------------------------------------------+
...
|                             |                                                                |
+-----------------------------+----------------------------------------------------------------+
| **Repo/commit-ID**          | nonrtric-controlpanel/1ff7d34a8c3fa9041467dfe1209d1126691cf530 |
|                             |                                                                |
+-----------------------------+----------------------------------------------------------------+
| **Release designation**     | N                                                              |
|                             |                                                                |
...
|                             |                                                                |
+-----------------------------+----------------------------------------------------------------+
| **Purpose of the delivery** | nonrtric-gateway:1.3.1                                         |
